...
public class LoadingDialog extends Dialog {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        timerTask = new TimerTask() {
            @Override
            public void run() {
                Log.e("TAG", "run: "+pbLoading.getProgress() );
                pbLoading.setProgress((int) (pbLoading.getProgress()+Math.random()*3));
        ...
        timer.schedule(timerTask, 0,50); //每隔5秒执行TimeTask的run方法
